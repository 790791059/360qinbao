...
function bindData(){
    ...
    for(var i=0;i<6;i++){
        $(".teaList")[0].innerHTML+="<tr> <th>"+classArr[i].classId+"</th> <th>"+classArr[i].classNum+"</th> <th>"+classArr[i].classTypeName+"</th> " +
            ...
            "<button onclick='updateClass("+classArr[i].classId+",this)' >修改</button> <button onclick='delEach("+classArr[i].classId+",this)' >删除</button> <button onclick='shengClass("+classArr[i].classId+",this)'>升级</button> </th> </tr>"
    }
}
//    增加班级
function addData(){
